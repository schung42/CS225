...
class KDTree
{
    ...
    private:
        ...
        //helpers
        void createKDTree(int left, int right, int size);

        void choose(int left, int right, int size, int median);

        int partitionKDTree(int left, int right, int size, int median);

        void swap(int swap1, int swap2);

        Point<Dim> FindNearestNeighborHelp(int left, int right, int level, Point<Dim> targetPoint) const;
         ...
         */
         ...
         int shouldReplaceHelper(const Point<Dim> & target1, const Point<Dim> & target2) const;
};
